...
import { deleteTemplate } from "src/helpers/contentHelper";


const TemplateTable = ({ openEditPopup, data, openDeleteTemplate, setOpenDeleteTemplate }) => {
    ...
    const handleDelete = async (val) => {
        ...
        try {
            const res = await deleteTemplate(currentOrgId, val?.template_id)
        } finally {
    ...
    return (
        <>
                ...
                <Table aria-label="customer table">
                    ...
                    <TableBody>
                        ...
                        {data?.map((val) => {
                            return (
                                <TableRow >
                                    <TableCell>{val?.template_id}</TableCell>
                                    <TableCell>{val?.template_name}</TableCell>
                                    <TableCell>
                                        {val?.description}
                                    </TableCell>
                                    <TableCell>
            ...
            >
                ...
                <MenuItem sx={{ color: 'error.main' }} onClick={() => setOpenDeleteTemplate(true)}>
            ...
            <Dialog
                ...
                onClose={() => setOpenDeleteTemplate(false)}
